...
const rentedCars = [
    {
        ...
        status: "Return before May 05, 2025",
    },
    {
        id: "2",
        name: "2016 Toyota Camry",
    ...
    },
    {
        ...
        imageUrl: "https://images.unsplash.com/photo-1550355291-bbee04a92027?auto=format&fit=crop&q=80&w=2156",
        returnDate: "May 05, 2025",
        status: "Returned at May 05, 2025",
        isReturned: true,
        withPenalty: true,
    },
]
                    ...
                    {rentedCars.map((car) => (
                        <div key={car.id} className="bg-white rounded-lg overflow-hidden shadow-sm">
                            <div className="relative">
                                ...
                                <span
                                    className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm ${car.isReturned
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex justify-between items-center">
                                    {car.isReturned ? (
                                        <span className={`text-sm ${car.withPenalty ? "text-red-600" : "text-gray-600"}`}>
                                            {car.withPenalty ? "With Penalty" : "Completed"}
                                        </span>
                                    ) : car.isDue ? (
